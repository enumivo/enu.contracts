...
namespace enumivo {
   ...
   class multisig : public contract {
      ...
      private:
         ...
         typedef enumivo::multi_index<N(approvals), old_approvals_info> old_approvals;
         ...
         typedef enumivo::multi_index<N(approvals2), approvals_info> approvals;
         ...
         typedef enumivo::multi_index<N(invals), invalidation> invalidations;
};
