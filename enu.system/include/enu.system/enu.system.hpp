...
namespace enumivosystem {
   ...
   typedef enumivo::multi_index< N(bidrefunds), bid_refund> bid_refund_table;
   ...
   typedef enumivo::multi_index< N(producers), producer_info,
                               ...
                               >  producers_table;
   typedef enumivo::multi_index< N(producers2), producer_info2 > producers_table2;
   ...
   typedef enumivo::singleton<N(global3), enumivo_global_state3> global_state3_singleton;
