...
namespace enumivosystem {
   ...
   void system_contract::buyram( account_name payer, account_name receiver, asset quant )
   {
      ...
      INLINE_ACTION_SENDER(enumivo::token, transfer)( N(enu.token), {{payer,N(active)},{N(enu.ram),N(active)}},
  ...
  /**
   ...
   void system_contract::sellram( account_name account, int64_t bytes ) {
      ...
      INLINE_ACTION_SENDER(enumivo::token, transfer)( N(enu.token), {{N(enu.ram),N(active)},{account,N(active)}},
   ...
   void system_contract::refund( const account_name owner ) {
      ...
      INLINE_ACTION_SENDER(enumivo::token, transfer)( N(enu.token), {{N(enu.stake),N(active)},{req->owner,N(active)}},
